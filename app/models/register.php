...
class Register extends AppModel
{
    public $validation = array(
        'password' => array(
                ...
                'length' => array('validate_between', 8, 50),
            ),
        'username' => array('length' => array('validate_between', 1, 50)),
        'first_name' => array('length' => array('validate_between', 1, 50)),
        'last_name' => array('length' => array('validate_between', 1, 50)),
        'email' => array('length' => array('validate_between', 1, 50))
    );
